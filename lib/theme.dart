...
appThemeData() {
  return ThemeData(
          // colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.lightGreen).copyWith(primarySwatch: forestGreenColor, background: mistColor).copyWith(error: darkRedColor))
          colorScheme: ColorScheme
          .fromSwatch(primarySwatch: Colors.lightGreen)
          .copyWith(background: mistColor, primary: forestGreenColor)
          // .copyWith(primarySwatch: forestGreenColor, background: mistColor)
...
MaterialColor forestGreenColor = MaterialColor(
  const Color.fromRGBO(224, 130, 7, 1).value,
  const <int, Color>{
    50: Color.fromRGBO(166, 224, 7, 0.1),
    100: Color.fromRGBO(166, 224, 7, 0.2),
    200: Color.fromRGBO(166, 224, 7, 0.3),
    300: Color.fromRGBO(166, 224, 7, 0.4),
    400: Color.fromRGBO(166, 224, 7, 0.5),
    500: Color.fromRGBO(166, 224, 7, 0.6),
    600: Color.fromRGBO(166, 224, 7, 0.7),
    700: Color.fromRGBO(166, 224, 7, 0.8),
    800: Color.fromRGBO(166, 224, 7, 0.9),
    900: Color.fromRGBO(166, 224, 7, 1),
  },
);
